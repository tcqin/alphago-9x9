...
from policy_net import RolloutNetwork
from features import tensorfy_game_rollout

data_dir = "data/9x9_filtered"
d = GoDataset(data_dir, tensorfy_game_rollout)
...
for epoch in range(start_epoch, num_epochs):
    ...
    torch.save(model.state_dict(), f"models/alphago_rollout_epoch_{epoch}.pth")
